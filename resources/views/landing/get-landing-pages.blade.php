        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-9 col-xs-12">
                <div class="card-box profile-section">
                    ...
                    <div class="d-flex justify-content-center manage-styles">
                        <div class="btn-group" role="group" aria-label="Basic example">
                            <a href="{{route('get_create_landing_page')}}" class="btn btn-success"> <i class="fa-solid fa-plus"></i> اضافة صفحة جديدة </a>
                        </div>
                    </div>


                    <div class="pages-cards mt-5">
                        <div class="row">
                            @if(!empty($data))
