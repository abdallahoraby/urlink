				...
				<div class="col-lg-8 col-xs-12">
                    ...
                    <div class="lndg-page-sections">
						...
						<div class="landing-content">
							...
							<div class="lndg-sec lndg-social-sec bg-rond social-style-list">
								<ul>
									...
									<li>
										<div class="social-item">
											<a href="{{$link['link_url']}}" class="facebook-link out-line-st" target="_blank"><i class="fa-brands fa-facebook-f"></i> للتواصل عبر الفيس بوك </a>
										</div>
									</li>
									...
									<li>
										<div class="social-item">
											<a href="{{$link['link_url']}}" class="twitter-link out-line-st" target="_blank"> <i class="fa-brands fa-twitter"></i> تابعني على تويتر</a>
										</div>
									</li>
									...
									<li>
										<div class="social-item">
											<a href="{{$link['link_url']}}" class="insta-link out-line-st" target="_blank"><i class="fa-brands fa-instagram"></i> راسلني على انستجرام</a>
										</div>
									</li>
									...
									<li>
										<div class="social-item">
											<a href="{{$link['link_url']}}" class="whatsapp-link out-line-st" target="_blank"><i class="fa-brands fa-whatsapp"></i> راسلني على واتساب</a>
										</div>
									</li>
                                    @endif
