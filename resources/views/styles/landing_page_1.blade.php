			...
			<div class="row justify-content-center">
				<div class="col-lg-8 col-xs-12">
                    ...
                    <div class="lndg-page-sections">
						<!-- Landing Top Section -->
                        @if(isset($data['page_profile_banner']))
						    <div class="lndg-main-top-sec " style="background-image: url({{asset($data['page_profile_banner'])}});" >
                        @else
                            <div class="lndg-main-top-sec " style="background-image: url({{asset('assets/img/background/bg_img_01.jpg')}});" >
                        @endif
