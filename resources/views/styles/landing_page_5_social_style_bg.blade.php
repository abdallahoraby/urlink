                                    ...
                                    @foreach($data['links'] as $link)
                                        ...
                                        <li>
                                            <div class="social-item">
                                                <a href="{{$link['link_url']}}" class="facebook-link" target="_blank"><i class="fa-brands fa-facebook-f"></i> للتواصل عبر الفيس بوك </a>
                                            </div>
                                        </li>
                                        ...
                                        <li>
                                            <div class="social-item">
                                                <a href="{{$link['link_url']}}" class="twitter-link" target="_blank"> <i class="fa-brands fa-twitter"></i> تابعني على تويتر</a>
                                            </div>
                                        </li>
                                        ...
                                        <li>
                                            <div class="social-item">
                                                <a href="{{$link['link_url']}}" class="insta-link" target="_blank"><i class="fa-brands fa-instagram"></i> راسلني على انستجرام</a>
                                            </div>
                                        </li>
                                        ...
                                        <li>
                                            <div class="social-item">
                                                <a href="{{$link['link_url']}}" class="whatsapp-link" target="_blank"><i class="fa-brands fa-whatsapp"></i> راسلني على واتساب</a>
                                            </div>
                                        </li>
                                        @endif
                                    @endforeach
