                                    ...
                                    @foreach($data['links'] as $link)
                                                ...
                                                <li class="list-inline-item">
                                                    <div class="social-item">
                                                        <a href="{{$link['link_url']}}" class="facebook-link out-line-st" target="_blank"><i class="fa-brands fa-facebook-f"></i></a>
                                                    </div>
                                                </li>
                                                <!-- Twitter -->
                                                ...
                                                <li class="list-inline-item">
                                                    <div class="social-item">
                                                        <a href="{{$link['link_url']}}" class="twitter-link out-line-st" target="_blank"> <i class="fa-brands fa-twitter"></i></a>
                                                    </div>
                                                </li>
                                                <!-- Insta -->
                                                ...
                                                <li class="list-inline-item">
                                                    <div class="social-item">
                                                        <a href="{{$link['link_url']}}" class="insta-link out-line-st" target="_blank"><i class="fa-brands fa-instagram"></i></a>
                                                    </div>
                                                </li>
                                                <!-- Whatsapp -->
                                                ...
                                                <li class="list-inline-item">
                                                    <div class="social-item">
                                                        <a href="{{$link['link_url']}}" class="whatsapp-link out-line-st" target="_blank"><i class="fa-brands fa-whatsapp"></i></a>
                                                    </div>
                                                </li>
                                                @endif
