				...
				<div class="col">
                    <div class="sec-div">
                        <div class="prv-sec-title">
                            <h3>
                                @if($termsData['header_title'])
                                    {!!$termsData['header_title']!!}
                                @else
                        ...
                        <p>
                            @if($termsData['header_content'])
                                {!!$termsData['header_content']!!}
                            @else
			...
			<div class="row">
				<div class="col">
                    <div class="sec-div">
                        <div class="prv-sec-title">
                            <h3>
                                @if($termsData['body_title'])
                                    {!!$termsData['body_title']!!}
                                @else
                            ...
                            <ul>
                                @if($termsData['body_content'])
                                {!!$termsData['body_content']!!}
                                @else
                                <li>
                                    <p>
