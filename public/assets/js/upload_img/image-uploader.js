...
(function ($) {
    ...
    $.fn.imageUploader = function (options) {
        ...
        let defaults = {
            ...
            extensions: ['.jpg', '.jpeg', '.png','.PNG', '.gif', '.svg'],
        ...
        let createContainer = function () {
            ...
            let $uploadedContainer = $('<div>', {class: 'uploaded'}).appendTo($container),
                ...
                $i = $('<i>', {class: 'fi-rr-cloud-upload-alt'}).appendTo($textContainer),
        ...
        let createImg = function (src, id, preloaded) {
            ...
            let $container = $('<div>', {class: 'uploaded-image'}),
                ...
                // Create checkBox
                // $div01 = $('<div>', {class: 'form-check'}).appendTo($container),
                // $div02 = $('<input>', { class: 'form-check-input',  type: 'radio',  name:'gridRadios',  value:'option1', id: 'gridRadiosSS' + '[x]'}).appendTo($div01),

                
                // $('<input>', {  type: 'checkbox', id: 'exampleCheck1' + '[]',  }).appendTo($div01),
